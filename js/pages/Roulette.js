...
export default {
            ...
            <div class="sidebar">
                ...
                <form class="options">
                    <div class="check">
                        ...
                        <label for="main">Top 17 levels</label>
                    </div>
                    <div class="check">
                        <input type="checkbox" id="extended" value="Extended List" v-model="useExtendedList">
                        <label for="extended">Levels below top 17</label>
                    </div>
                    ...
                    <template v-if="levels.length > 0">
                        ...
                        <div class="level" v-if="!hasCompleted">
                            ...
                            <div class="meta">
                                ...
                                <h2><a class="director" :href="'https://noyansdemonslist.vercel.app/#/level/' + currentLevel.path" target="_blank">{{ currentLevel.name }}</a></h2>
                                <div>
                                    <div style="display: inline-block; width: 50%;">
    ...
    methods: {
        ...
        async onStart() {
            ...
            const list = [];
            if (this.useMainList) {
                list.push(...fullListMapped.slice(0, 17));
            }
            if (this.useExtendedList) {
                list.push(...fullListMapped.slice(17));
            }
